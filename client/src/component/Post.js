...
function Post() {
    ...
    useEffect(()=>{
      const fetchData= async function(){
        await axios.post(`${process.env.REACT_APP_SERVER_URL}`+"/success/check",{id: state.id,pid: state.post._id},{withCredentials: true}).then((res)=>{
    ...
    function like(post,id,i){
      axios.post(`${process.env.REACT_APP_SERVER_URL}`+"/success/like",{...post,id: id},{withCredentials: true}).then((res)=>{
    ...
    function comment(post,id,i){
      axios.post(`${process.env.REACT_APP_SERVER_URL}`+'/success/comment',{...post,id: id,comment: c},{withCredentials: true}).then((res)=>{
